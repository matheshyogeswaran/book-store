package com.mathesh.book_store.service.impl;

import com.mathesh.book_store.dto.BookDto;
import com.mathesh.book_store.entity.Book;
import com.mathesh.book_store.mapper.BookMapper;
import com.mathesh.book_store.repository.BookRepository;
...
public class BookServiceImpl implements BookService {
    ...
    public BookDto updateBookName(BookDto bookDto) {
        ...
        Book book = bookRepository.findBooksByBookId(bookDto.bookId());
